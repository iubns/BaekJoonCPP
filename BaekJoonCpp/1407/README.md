[#1407. 2로 몇 번 나누어질까](https://www.acmicpc.net/problem/1407)
![solve](https://img.shields.io/badge/solve-fail-brightred)
...
## 기타 (ETC)
> 아무리 생각해도 내가 처음부터 유도 할 수 없는 문제,
> 규칙은 찾을 수 있으나 점화식 유도가 쉽지 않다.